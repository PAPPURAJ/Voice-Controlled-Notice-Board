...
#include <LiquidCrystal_I2C.h> 
 ...
 #define FIREBASE_HOST "voicenotice-ee714-default-rtdb.firebaseio.com"  //Database link
 #define FIREBASE_AUTH "N5Q7C9xl7HcVMDiTB5QnGPeBghbUaBG3HpQXjU65"  //Database secrate
